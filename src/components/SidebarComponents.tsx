            ...
            <div className="flex flex-col justify-between flex-1 pt-2">
                <div>
                    ...
                    <nav className="px-8 space-y-1">
                        <SidebarLink
                            icon={<Icon icon="ph:house-bold" className="h-5 w-5" />}
                            text="Dashboard"
                            to="/dashboard"
                        />
                    </nav>
                    ...
                    <nav className="px-8 space-y-1">
                        <SidebarLink
                            icon={<Icon icon="jam:medical" className="h-5 w-5" />}
                            text="Directory"
                            to="/obgyndirectory"
                        />
                        <SidebarLink
                            icon={<Icon icon="mingcute:send-fill" className="h-5 w-5" />}
                            text="Approvals"
                            to="/approvals-list"
                        />
                    </nav>
                    ...
                    <nav className="px-8 space-y-1">
                        <SidebarLink
                            icon={<Icon icon="ic:baseline-people-alt" className="h-5 w-5" />}
                            text="Forum"
                            to="/forum-management"
                        />
                        <SidebarLink
                            icon={<Icon icon="mingcute:hospital-fill" className="h-5 w-5" />}
                            text="Health Centers"
                            to="/healthcenter-management"
                        />
                        <SidebarLink
                            icon={<Icon icon="material-symbols:library-books-rounded" className="h-5 w-5" />}
                    ...
                    <nav className="px-8 space-y-1">
                        <SidebarLink
                            icon={<Icon icon="ic:twotone-payment" className="h-5 w-5" />}
                            text="Service Fee"
                            to="/service-fee"
                        />
                    </nav>
                ...
                <div className="px-8 mb-4 space-y-1">
                    ...
                    <SidebarLink
                        icon={<Icon icon="ph:gear-six-bold" className="h-5 w-5" />}
                        text="Settings"
                        to="/settings"
                    />
                    {/* ✅ Logout button now calls signOut */}
                    <button

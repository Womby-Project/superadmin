...
const ArchiveTab: React.FC<ArchiveTabProps> = ({ posts, onViewPost }) => {
    ...
    <div>
      ...
      <div className="bg-white p-3 rounded-lg shadow mb-6 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          {/* Tag filter placeholder (hook to Supabase later) */}
          <div className="relative">
            <button
      ...
      {filteredPosts.length === 0 ? (
        <div className="text-center text-gray-500 py-8">No archived posts.</div>
      ) : (
